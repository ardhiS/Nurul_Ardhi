      ...
      <div className='section-container relative z-10'>
        ...
        <div className='space-y-8 max-w-4xl mx-auto'>
          {giftOptions.map((option, categoryIndex) => (
            ...
            >
              <h4 className='font-serif text-2xl text-pink-600 mb-8 text-center'>
                {option.type}
              </h4>
        ...
        >
          <div className='bg-gradient-to-br from-pink-50 to-accent-50 rounded-3xl p-8 md:p-10 max-w-2xl mx-auto border border-pink-200 shadow-lg'>
            ...
            <div className='space-y-4'>
              <div className='flex items-center gap-4 bg-white rounded-2xl p-4 shadow-sm border border-pink-100'>
              ...
              <div className='flex items-center gap-4 bg-white rounded-2xl p-4 shadow-sm border border-blue-100'>
